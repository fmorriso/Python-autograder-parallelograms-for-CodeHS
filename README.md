...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/python-codehs-autograder-paralleograms.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/python-codehs-autograder-paralleograms/-/settings/integrations)
